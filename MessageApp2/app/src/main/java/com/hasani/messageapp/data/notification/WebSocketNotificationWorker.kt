...
class WebSocketNotificationWorker @AssistedInject constructor(
    ...
    private fun createForegroundInfo(): androidx.work.ForegroundInfo {
        ...
        val notification = androidx.core.app.NotificationCompat.Builder(applicationContext, com.hasani.messageapp.data.notification.NotificationHelper.BACKGROUND_CHANNEL_ID)
            .setContentTitle("")
            .setContentText("")
            .setSmallIcon(com.hasani.messageapp.R.drawable.ic_launcher_foreground)
            .setOngoing(true)
