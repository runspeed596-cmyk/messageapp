...
import com.hasani.messageapp.data.repository.StoryRepository
...
class StoryViewModel @Inject constructor(
    ...
    private val _currentUser = MutableStateFlow<com.hasani.messageapp.domain.model.User?>(null)
    val currentUser: StateFlow<com.hasani.messageapp.domain.model.User?> = _currentUser.asStateFlow()
    ...
    private val _viewersState =
        MutableStateFlow<List<com.hasani.messageapp.domain.model.StoryViewer>>(emptyList())
    val viewersState: StateFlow<List<com.hasani.messageapp.domain.model.StoryViewer>> =
