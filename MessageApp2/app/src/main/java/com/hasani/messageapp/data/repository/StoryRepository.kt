...
import com.hasani.messageapp.data.local.dao.StoryDao
import com.hasani.messageapp.data.local.entity.StoryEntity
import com.hasani.messageapp.data.local.entity.StoryUserEntity
import com.hasani.messageapp.data.mapper.toDomain
import com.hasani.messageapp.data.remote.api.StoryApiService
...
class StoryRepository @Inject constructor(
        ...
        return StoryUser(
             ...
             stories = stories.map { story ->
                 Story(
                     ...
                     userId = story.userId,
                     mediaUrl = story.mediaUrl,
                     type = com.hasani.messageapp.domain.model.StoryType.valueOf(story.type),
                     caption = story.caption,
     ...
     * Get story views
     */
    suspend fun getStoryViews(storyId: String): Result<List<com.hasani.messageapp.domain.model.StoryViewer>> {
        return try {
