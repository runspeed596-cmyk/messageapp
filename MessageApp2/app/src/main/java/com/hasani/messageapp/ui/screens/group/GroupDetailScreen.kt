...
import com.hasani.messageapp.ui.viewmodel.GroupDetailViewModel
...
fun GroupDetailScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.events.collect { event ->
            when (event) {
                is com.hasani.messageapp.ui.viewmodel.GroupEvent.GroupDeleted,
                is com.hasani.messageapp.ui.viewmodel.GroupEvent.GroupLeft -> {
                    onGroupDeleted()
                }
                is com.hasani.messageapp.ui.viewmodel.GroupEvent.Error -> {
