...
import com.hasani.messageapp.data.local.dao.ChatDao
import com.hasani.messageapp.data.local.dao.GroupMessageDao
...
import com.hasani.messageapp.data.remote.dto.CreateChatRequest
import com.hasani.messageapp.data.remote.dto.EditMessageRequest
import com.hasani.messageapp.data.remote.dto.SendMessageRequest
import com.hasani.messageapp.data.sync.SyncCoordinator
import com.hasani.messageapp.domain.mapper.*
...
class ChatRepository @Inject constructor(
     ...
     */
    private suspend fun saveChatWithParticipants(chatDto: com.hasani.messageapp.data.remote.dto.ChatDto) {
        ...
        val participantEntities = chatDto.participants.map { user ->
            com.hasani.messageapp.data.local.entity.ChatParticipantEntity(
                chatId = chatDto.id,
                userId = user.id
            )
        }
...
class MessageRepository @Inject constructor(
    ...
    suspend fun reactToMessage(messageId: String, reaction: String?, isGroup: Boolean = false, groupId: String? = null): Result<Unit> {
        ...
        val request = com.hasani.messageapp.data.remote.dto.ReactionRequest(reaction)
        return try {
    ...
    suspend fun sendPollMessage(
        chatId: String,
        pollDto: com.hasani.messageapp.data.remote.dto.PollDto
    ): String {
        val messageId = "local_${java.util.UUID.randomUUID()}"
        val now = System.currentTimeMillis()
        ...
        val entity = MessageEntity(
            ...
            // It is imported: com.hasani.messageapp.data.local.entity.MessageEntity
        )
