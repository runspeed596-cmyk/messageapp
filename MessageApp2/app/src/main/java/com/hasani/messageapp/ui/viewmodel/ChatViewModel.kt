...
import com.hasani.messageapp.data.repository.ChatRepository
import com.hasani.messageapp.data.repository.ChannelRepository
import com.hasani.messageapp.data.repository.ContactsRepository
import com.hasani.messageapp.data.repository.GroupRepository
import com.hasani.messageapp.data.repository.MessageRepository
...
import com.hasani.messageapp.data.websocket.WebSocketManager
...
import com.hasani.messageapp.data.voice.VoiceRecorderManager
import com.hasani.messageapp.data.audio.AudioPlayerManager
import com.hasani.messageapp.data.location.LocationManager
            ...
            viewModelScope.launch {
                ...
                if (filter == SearchFilter.ALL || filter == SearchFilter.CHANNEL) {
                    channelRepository.searchChannels(query).collect { result ->
                        if (result is com.hasani.messageapp.data.repository.ChannelResult.Success) {
...
class NewChatViewModel @Inject constructor(
    ...
    private val chatRepository: ChatRepository,
    private val contactsRepository: ContactsRepository,
    private val privacyManager: com.hasani.messageapp.domain.privacy.PrivacyManager
) : ViewModel() {
