...
import com.hasani.messageapp.data.local.AppDatabase
...
object DatabaseModule {
    ...
    @Provides
    fun provideCourseDao(database: AppDatabase): com.hasani.messageapp.data.local.dao.CourseDao = database.courseDao()
}
