...
import com.Kelasor.app.ui.navigation.NavGraph
            ...
            MessageAppTheme(darkTheme = darkTheme, colorPalette = colorPalette) {
                Surface(
                    ...
                    if (isPinLockEnabled && storedPin != null && !isUnlocked) {
                            com.Kelasor.app.ui.screens.auth.PinLockScreen(
                        ...
                        androidx.compose.foundation.layout.Box(modifier = Modifier.fillMaxSize()) {
                            ...
                            val connectivityObserver = remember { com.Kelasor.app.util.ConnectivityObserver(applicationContext) }
                            val isConnected by connectivityObserver.isConnected.collectAsState(initial = true)
                            
                            com.Kelasor.app.ui.components.NetworkConnectivityBanner(
